            ...
            <form action="{{ route('finance.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="category_id" id="category_id"
                        class="w-full rounded-lg border-slate-300 text-slate-700 focus:border-blue-500 focus:ring-blue-500 shadow-sm"
                        required>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="amount" id="amount" step="0.01" min="0.01"
                                class="pl-12 w-full rounded-lg border-slate-300 text-slate-700 focus:border-blue-500 focus:ring-blue-500 shadow-sm"
                ...
                <div class="pt-4 flex justify-end gap-3 border-t border-slate-100">
                    ...
                    <button type="submit"
                        class="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-sm transition-colors">Record
                        Transaction</button>
                </div>
            </form>
        </div>
