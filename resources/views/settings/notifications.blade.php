    ...
    <div class="space-y-10">
        ...
        <div>
            <nav class="flex text-[10px] font-bold text-zenith-300 uppercase tracking-widest mb-2 gap-2 items-center">
                ...
                <span class="text-zenith-500">Autonomous Alerts</span>
            </nav>
            <h2 class="text-3xl font-display font-black text-zenith-900 tracking-tight">Notification Rules</h2>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-12 items-start">
            ...
            <div class="lg:col-span-3 space-y-8">
                <div
                    ...
                    <h3 class="text-2xl font-black text-zenith-900 mb-2">Autonomous Alert Matrix</h3>
                    <p class="text-sm text-zenith-400 font-medium max-w-md mx-auto mb-8">Intelligent event-based
                        notification nodes are currently governed by global system defaults to maintain high-integrity
                        protocols.</p>
                    <div class="flex items-center gap-4">
                        <div
                            ...
                            GLOBAL DEFAULT PROTOCOL: ENFORCED
                        </div>
                    </div>
                </div>
            </div>
