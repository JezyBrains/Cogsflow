            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center mb-5">
                    ...
                    <p class="lead text-muted">
                        Everything you need to manage your grain operations efficiently.
                    </p>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="text-center">
                        ...
                        <h4 class="mt-3 mb-3">Batch Management</h4>
                        <p class="text-muted">Comprehensive batch tracking with quality control.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="text-center">
                        ...
                        <h4 class="mt-3 mb-3">Dispatch Management</h4>
                        <p class="text-muted">Real-time tracking and delivery confirmation.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="text-center">
                        ...
                        <h4 class="mt-3 mb-3">Purchase Orders</h4>
                        <p class="text-muted">Streamlined procurement workflow.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <p class="lead text-muted mb-4">
                        Ready to transform your grain management operations?
                    </p>
                    
                    <div class="row g-4 mb-4">
                        <div class="col-md-4">
                            <i class="bx bx-envelope" style="font-size: 2rem; color: #696cff;"></i>
                            <h6 class="mt-2">Email</h6>
                            <p class="text-muted"><?= $company_email ?? 'info@grainflow.com' ?></p>
                        </div>
                        <div class="col-md-4">
                            <i class="bx bx-phone" style="font-size: 2rem; color: #696cff;"></i>
                            <h6 class="mt-2">Phone</h6>
                            <p class="text-muted"><?= $company_phone ?? '+255 123 456 789' ?></p>
                        </div>
                        <div class="col-md-4">
                            <i class="bx bx-time" style="font-size: 2rem; color: #696cff;"></i>
